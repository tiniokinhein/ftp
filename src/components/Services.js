        ...
        return (
            ...
            >
                <div className="container">
                    <h3
                        className="bold-header text-center text-uppercase text-white mb-3"
                        style={{
                            letterSpacing: '2px',
                            fontSize: '3rem',
                            lineHeight: '1em',
                    ...
                    <h4
                        className="text-uppercase headTitle text-center"
                        style={{
                            fontSize: '2rem',
                            letterSpacing: '1px',
                            color: '#ffc107',
                        ...
                        >
                            {
                                software ? (
                                    ...
                                    >
                                        ...
                                        />
                                        <h2
                                            className="headTitle text-center text-white mt-3 mb-4"
                                            style={{
                                                fontSize: '22px',
                                                letterSpacing: '1px',
                                                lineHeight: '1.5em',
                                        ...
                                        >
                                            <Link
                                                ...
                                                className="more-link px-3 py-2 rounded-0 headTitle text-capitalize text-dark bg-warning text-decoration-none"
                                                style={{
                                                    letterSpacing: '1px',
